...
@WebFilter(urlPatterns = {"/users/private/*","/board/private/*","/file/private/*"})
public class LoginFilter implements Filter{
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		if(id!=null) {
			...
			//GET 방식 전송 파라미터를 query 문자열로 읽어오기
			...
			//리다일렉트 시킬 때 원래 목적지 정보를 url 라는 파라미터 명으로 같이 보낸다.
