...
<div class="container">
	...
	<form action="update.jsp" method="post">
		...
		<div style="float:right">
			<button style="float:auto; margin-top:5px;" class="btn btn-primary btn-sm" type="submit" onclick="submitContents(this)">수정확인</button>
			<a style="margin-top:5px;" class="btn btn-secondary btn-sm" href="${pageContext.request.contextPath }/board/detail.jsp?num=<%=dto.getNum()%>">취소</a>
		</div>
	</form>
</div>
</body>
